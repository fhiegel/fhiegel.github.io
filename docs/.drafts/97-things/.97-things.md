...
Tout le contenu du livre est disponible sous license [Creative Commons Attribution-NonCommercial-ShareAlike 3.0 license](http://creativecommons.org/licenses/by-nc-sa/3.0/), sur [Github](https://github.com/97-things/97-things-every-programmer-should-know)

Je vous propose de balayer de manière superficielle ces 97 Astuces.
