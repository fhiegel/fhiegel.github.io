...
## Points, Badges and Leaderboards <!-- .element: class="fragment" data-fragment-index="1" -->

### are not <!-- .element: class="fragment" data-fragment-index="2" -->

### <span>(only) <!-- .element: class="fragment" data-fragment-index="4" --></span>

## Gamification <!-- .element: class="fragment" data-fragment-index="3" -->
...
<!-- .slide: data-background-image="assets/images/octalysis-v0.jpg" data-background-size="contain" -->
